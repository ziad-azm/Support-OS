 ...
 *   ]}
 *
 * A permission miss redirects to `/`, not to a 403 page — there is no 403
 * route in this app, and inventing one is a decision for the first feature
 * that needs it. `replace` keeps the unauthorized URL out of history.
 */
