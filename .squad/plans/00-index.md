...
| bugs | [bugs/00-overview.md](bugs/00-overview.md) | 99 (defect remediation, not a backlog epic — cut from `qa-report-1`; Story 99 (F-1/F-4) planned, Stories 100–105 (F-2, F-5..F-20) scoped in the overview but not yet written) |
